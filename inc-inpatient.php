...
$sql2 ="INSERT INTO `inc_review`(`inc_id`, `paitient_emp_id`, `fname`, `lname`, `inc_person`, `inc_details`, `nodate`, `date`, `department`, `location`, `rpt_location`, `inc_location`, `email`, `subscribe`, `curr_status`,`user`) VALUES ('$inc_id','$pid','$fname','$lname','$inc_person', '$inc_details','$nodate','$date','$inc_dpt','$ocunit', '$rpt_location', '$location', '$cemail','$subscribe','Reported','$loguser')";
